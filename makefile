...
makefile.conf: 
	coq_makefile all_MISBFS.v all_MIS_complete.v all_MISITerative.v all_MIS_Refine.v all_MIS_sound.v all_MIS_unique.v all_MIS.v eqtype.v explicit_graph.v fintype.v graph_basics.v graphs_nondep.v index.v lex_order.v lGraphMoonTheorem.v MIS1.v MIS_basics.v moon_lemma.v test_cases.v wf3.v wf4.v wf_combinators.v -o makefile

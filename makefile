...
# coq_makefile -o makefile MIS_basics.v abstract_graphs.v all_MIS.v all_MIS_complete.v all_MIS_sound.v all_MIS_unique.v eqtype.v fintype.v graph_basics.v graphs_nondep.v index.v lex_order.v test_cases.v 
#
